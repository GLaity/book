...
<<<<<<< HEAD:book-manager/book-front-web/src/main/webapp/Book_Read.jsp
<%@page import="java.io.BufferedReader"%>
<%@page import="java.io.FileReader"%>
<%@page import="java.io.File"%>
=======
<!DOCTYPE html>
>>>>>>> 9aa5724b7b14cdaffc33b01bf2b8a59dbc41778c:book-manager/book-front-web/src/main/webapp/ranking.jsp
<html>
<head>
    <meta charset="utf-8" />
    <title>排行榜</title>
