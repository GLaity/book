            ...
            <nav class="navbar navbar-expand-xl navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="userinformation.html">用户管理
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="accounts.html">作者管理</a>
                        </li>
                ...
                <div class="col-xl-7 col-lg-7 col-md-12">
                    <form action="" class="tm-edit-product-form">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input placeholder="书籍编号" value="" id="bookId" name="book_id" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7">
                        </div>
                        <div class="input-group mb-3">
                            <label for="context" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">简介：</label>
